 ...
 * Use the [ReferFriendFragment.newInstance] factory method to
...
class ReferFriendFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Set up the back arrow ImageView and its click listener
    ...
    companion object {
         ...
         * @return A new instance of fragment ReferFriendFragment.
         */
